...
namespace MyCharlotte
{
    public partial class CalendarViewController : UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            var calendar = new UIImageView(new CoreGraphics.CGRect(120, 80, View.Bounds.Width - 130, 150));
            calendar.ContentMode = UIViewContentMode.ScaleAspectFit;
            calendar.Image = UIImage.FromFile("images/calendar_demo.png");
            ...
            {
                Frame = new CoreGraphics.CGRect(140, 260, View.Bounds.Width - 170, 30),
            ...
            {
                Frame = new CoreGraphics.CGRect(120, 320, View.Bounds.Width - 130, 60),
                BackgroundColor = UIColor.White
            };
            firstButton.TitleLabel.Font = UIFont.SystemFontOfSize(24.0f);
            firstButton.SetTitle("Saved Event 1", UIControlState.Normal);
            ...
            {
                Frame = new CoreGraphics.CGRect(120, 400, View.Bounds.Width - 130, 60),
                BackgroundColor = UIColor.White
            };
            secondButton.TitleLabel.Font = UIFont.SystemFontOfSize(24.0f);
            secondButton.SetTitle("Saved Event 2", UIControlState.Normal);
            ...
            {
                Frame = new CoreGraphics.CGRect(120, 480, View.Bounds.Width - 130, 60),
                BackgroundColor = UIColor.White
            };
            thirdButton.TitleLabel.Font = UIFont.SystemFontOfSize(24.0f);
            thirdButton.SetTitle("Saved Event 3", UIControlState.Normal);
